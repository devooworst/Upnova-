    ...
    <>
      ...
      {!panelOpen ? (
        ...
        <button
          ...
          className="fixed bottom-36 right-3 z-[90] flex items-center gap-2 rounded-full border border-amber-400/50 lg:bottom-3 bg-[#141217]/95 px-3 py-1.5 shadow-2xl backdrop-blur transition hover:border-amber-300/70"
        ...
        <div ref={panelRef} className="fixed bottom-36 right-2 z-[90] w-[calc(100vw-1rem)] sm:right-3 sm:w-[min(30rem,calc(100vw-1.5rem))] lg:bottom-3">
