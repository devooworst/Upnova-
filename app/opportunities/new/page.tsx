...
export default function NewOpportunityPage() {
  ...
  return (
    <div className="mx-auto max-w-xl space-y-4">
      ...
      {showPreview && (
        <div className="fixed inset-0 z-50 flex items-end justify-center pb-[max(1rem,env(safe-area-inset-bottom))] sm:items-center sm:pb-0 bg-black/70 p-4 backdrop-blur-sm" onClick={() => setShowPreview(false)}>
