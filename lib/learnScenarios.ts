...
export const LEARN_SCENARIOS: LearnScenario[] = [
  {
    ...
    story: "Tasha is a hairstylist. After six months on UpNova she opens Clients and sees 32 people, sorted by their last visit — including Aaliyah, who's booked five times. That's her next Preferred Client.",
    flow: [
  ...
  },
  {
    ...
    why: "A barber plans a week out; a wedding photographer plans a year. Your calendar, your horizon — UpNova never assumes one schedule.",
  ...
  },
  {
    ...
    what: "Every payment on UpNova, tied to its real booking or project, with a frozen receipt.",
  ...
  },
  {
    ...
    why: "A photographer you hired once isn't an employee. UpNova keeps the difference honest.",
  ...
  },
  {
    ...
    tagline: "The same UpNova, organized for an organization.",
  ...
  },
  {
    ...
    what: "How UpNova's pieces combine into a loyalty engine: history → eligibility → Preferred status → benefits → early access.",
